...
$login = "http://sctg.xyz/in.php?key=LqgszvhRA4IOdYvrA5EBakY987xo6CDh|onlyxevil&method=userrecaptcha&googlekey=".$sit."&json=1&pageurl=https://coins-battle.com/game/claimreward";
$ua[] = "User-Agent: ".$vvv."";
...
if($id==''){goto a;}
c:
$url = "http://sctg.xyz/res.php?key=LqgszvhRA4IOdYvrA5EBakY987xo6CDh|onlyxevil&action=get&id=".$id."";
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $url);
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
